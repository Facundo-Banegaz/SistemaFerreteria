namespace Ferreteria.CapaPresentacion.VistaReporte
{
    partial class FrmReporteFacturaIngreso
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.spReporte_factura_IngresoTableAdapter = new Ferreteria.CapaPresentacion.DsPrincipalTableAdapters.SpReporte_factura_IngresoTableAdapter();
            ...
            reportDataSource1.Name = "SpReporteIngreso";
            reportDataSource1.Value = this.spReportefacturaIngresoBindingSource;
            this.reportViewer1.LocalReport.DataSources.Add(reportDataSource1);
            this.reportViewer1.LocalReport.ReportEmbeddedResource = "Ferreteria.CapaPresentacion.Reportes.RptFacturaIngreso.rdlc";
